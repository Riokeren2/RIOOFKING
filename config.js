...
global.namebot = 'Rio-Bot-MD'
global.nameown = 'Namanya Rio ×፝֟͜×'


/*============== STAFF ==============*/
global.owner = [
  ['6287834252642', 'Namanya Rio ×፝֟͜×', 'true']
...
/*============== WATERMARK ==============*/
global.wm = 'RIODWI_ラ | By ᴹᴿ᭄ RIO-WKWK ×፝֟͜×' //Main Watermark
global.wm2 = 'RIO-CANS🥰 ×፝֟͜×'
global.wm3 = 'RIOKEREN🗿'
global.botdate = `⻝ 𝗗𝗮𝘁𝗲: ${week} ${date}\n⻝ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `⻝ 𝗧 𝗜 𝗠 𝗘 : ${wktuwib}`
global.titlebot = `Riodwi_ラ | ʙʏ ${global.nameown}`
global.author = 'ᴹᴿ᭄ Riohehe×፝֟͜×' 
global.packname = 'ᴹᴿ᭄ Riohehe ×፝֟͜×'
...
/*============== GLOBAL BIO ==============*/
global.nameowner = 'ᴹᴿ᭄ Riohehe ×፝֟͜×'
global.umurowner = '16'
